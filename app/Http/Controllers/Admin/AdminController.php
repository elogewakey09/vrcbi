...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        $property['total_property']              = Property::count();
        $property['active_property']             = Property::active()->count();
        $property['total_running_property']      = Property::running()->count();
        $property['total_completed_property']    = Property::completed()->count();

        $investStatistics['total_invest']        = Invest::count();
        $investStatistics['total_invest_amount'] = Invest::sum('total_invest_amount');
        $investStatistics['total_due_amount']    = Invest::sum('due_amount');
        $investStatistics['total_profit']        = Invest::sum('total_profit');

        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'property', 'investStatistics'));
    }
